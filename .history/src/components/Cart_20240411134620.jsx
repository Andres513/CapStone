                        ...
                        <>
                            {cart.map((item, index) => (
                               ...
                               <form>
                                ...
                                <input id="ccn" type="tel" inputMode="numeric" pattern="[0-9\s]{13,19}" autoComplete="cc-number" maxLength="19" placeholder="xxxx xxxx xxxx xxxx" value={creditCard} onChange={handleCreditCard} required/>
                               </form>
                                    </>
                            ))}
