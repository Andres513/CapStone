...
import ProductsByPrices from './components/ProductsByPrices'
...
const handleSetPrice=(newPrice)=>{
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/products_by_prices" element={<ProductsByPrices products={products} price={price} setPrice={handleSetPrice}/>}/>
    </Routes>
    </>
  )
}
