 ...
 const handleLogout = () =>{
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/" element={<FetchProducts token={token} products={products} setProducts={handleSetProducts} price={price} setPrice={handleSetPrice} isLoggedIn={isLoggedIn}/>}/>
